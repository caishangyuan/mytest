<?php /* Smarty version 2.6.18, created on 2016-07-20 18:37:00
         compiled from public/login.tpl */ ?>
...
/pub/dologin" method="post" name="loginform" onsubmit="return checklogin();">
				...
				<div style="margin:5px auto;">
					...
					<span style="float:right;width:70%;text-align:left;"> 
						<input type="text" name="code" style="border:1px solid #cccccc;width:95px;margin-left:10px;" onblur="checkcode(this.value)" onkeyup="this.value=this.value.toUpperCase()">&nbsp;&nbsp;<img src="<?php echo $this->_tpl_vars['app']; ?>
/pub/code/" id="codepic" onclick="this.src='<?php echo $this->_tpl_vars['app']; ?>
/pub/code/'+Math.random()">
					</span>
				</div>
				<div class="nav"></div>
				<div class="line_nav" style="width:90%;margin:0 auto"></div>
