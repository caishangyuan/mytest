<?php /* Smarty version 2.6.18, created on 2016-07-15 14:08:31
         compiled from board/assist.tpl */ ?>
<script type="text/javascript">
	var address='<?php echo $this->_tpl_vars['url']; ?>
';
	if($(".info").html()==""){
		$(".info")
		.html("<a href='<?php echo $this->_tpl_vars['app']; ?>
/index/main'>首页</a> >> 内容管理 >> <font class=\"Cf60\">分区/版块</font>");
	}
...
/add",
			...
			success: function (data){
				if(data){
					...
					var html='<tr><td>　　||--　<a href="<?php echo $this->_tpl_vars['root']; ?>
/index.php/subject/index/bid/'+data.id+'" target="_black">'+data.name+'</a></td>';
					html+='<td width="20%"><a href="<?php echo $this->_tpl_vars['root']; ?>
/space.php/index/index/uid/'+data.master+'" target="_black">　　'+data.masterName+'</a></td>';
					html+='<td width="30%">　　【<a href="javascript:void(0)" onclick="modify(this,\''+data.id+'\',\''+data.name+'\',\''+data.masterName+'\')">修改</a>】【<a href="<?php echo $this->_tpl_vars['root']; ?>
/admin.php/board/del/id/'+data.id+'">删除版块</a>】</td></tr>';
...
/add",
			...
			success: function (data){
				if(data){
					...
					html+='<td width=30%>【<a href="javascript:void(0);" onclick="add_board(this,'+data.id+')">添加版块</a>】【<a href="javascript:void(0);" onclick="mod_area(this,'+data.id+')">修改</a>】【<a href="<?php echo $this->_tpl_vars['url']; ?>
/del/id/'+data.id+'" onclick="if(confirm(\'确认删除？\')){return true;}else{return false;}">删除</a>】</td></tr>';
					$(obj).parents('tr').replaceWith(html);
