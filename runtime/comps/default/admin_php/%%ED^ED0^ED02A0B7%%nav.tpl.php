...
<div id="nav">
   <ul>
		<li class='bg_image'><a href='<?php echo $this->_tpl_vars['app']; ?>
/index/menu/operate/1' target='menu'>系统设置</a></li>
		<li class='bg_image'><a href='<?php echo $this->_tpl_vars['app']; ?>
/index/menu/operate/2' target='menu'>内容管理</a></li>
		<li class='bg_image'><a href='<?php echo $this->_tpl_vars['app']; ?>
/index/menu/operate/4' target='menu'>用户管理</a></li>
		<li class='bg_image'><a href='<?php echo $this->_tpl_vars['app']; ?>
/index/menu/operate/5' target='menu'>新闻/公告</a></li>
	</ul>
</div>
</body>
</html>