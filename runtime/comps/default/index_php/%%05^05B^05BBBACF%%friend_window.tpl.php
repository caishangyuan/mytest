<?php /* Smarty version 2.6.18, created on 2016-07-15 14:07:24
         compiled from public/friend_window.tpl */ ?>
<style type="text/css">
	/*盒子公共样式*/
	.f_window_back{
		display:none;
...
/images/title.png") repeat-x scroll 0 0 #EAF1F2;
	...
	.f_window_box_back .close a{
		...
		width:20px;
		height:20px;
		background:#F8F8F8 url("<?php echo $this->_tpl_vars['res']; ?>
/images/cls.gif") repeat-x 0 0;		
	}
	.f_window_box_back .close a:hover{
		...
		height:20px;
		background:#F8F8F8 url("<?php echo $this->_tpl_vars['res']; ?>
/images/cls.gif") repeat-x 0 -20px;	
	}
	/*自定义内容样式*/
	...
	.f_window_content #login_btn{
		background: url("<?php echo $this->_tpl_vars['res']; ?>
/images/pn.png") repeat-x scroll 0 -48px transparent;
		border: 0 none;
